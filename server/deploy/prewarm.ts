/**
 * Pre-warm the transcript cache for the videos used in the README, docs, and launch video.
 *
...
/** Paste these exact strings on the landing page for an instant, cache-backed result: the cache key hashes the raw source string. */
const SOURCES = [
