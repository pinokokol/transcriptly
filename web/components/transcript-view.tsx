...
export function TranscriptView({ transcript, agentFetched }: { transcript: TranscriptJson; agentFetched: boolean }) {
  ...
  return (
    // The entrance animation lives on a wrapper: a transform on the card itself
    // would trap the ice offset (z-index -1) above the card background.
    <div className="animate-fade-up">
      <Shell className="offset-card">
        <div className="p-5 sm:p-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="mt-1 flex flex-wrap items-center gap-2 font-mono text-[11px] text-muted-foreground">
                ...
                {duration(transcript.metadata.duration) && <span>{duration(transcript.metadata.duration)}</span>}
          ...
          <div className="mt-5 max-h-104 space-y-3.5 overflow-y-auto border-t border-foreground/[0.07] pt-5 pr-2">
