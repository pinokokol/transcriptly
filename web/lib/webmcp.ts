  ...
  await context.registerTool(
    {
      ...
      description:
        "Transcribe a video or audio URL (YouTube, TikTok, direct media links) and return the transcript. Formats: md, txt, json, srt. The transcript is also shown to the human on the page.",
      inputSchema: {
        type: "object",
        properties: {
